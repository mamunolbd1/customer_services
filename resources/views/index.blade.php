                        ...
                        <div class="row my-3 g-5">                      
                            <div class="col-md-6">
                                <div class="form-group d-inline-flex align-items-center justify-content-between w-100">
                                    ...
                                    <input type="text" class="form-control shadow-sm rounded" value="" name="customer_name">
                                </div>
                                <div class="form-group d-inline-flex align-items-center justify-content-between w-100">
                                    <label class="form-label mr-2 mb-0">Phone Number:</label>
                                    <input type="number" class="form-control shadow-sm rounded" value="{{ $phone_number }}" name="phone_number">
                                </div>
                                <div class="form-group d-inline-flex align-items-center justify-content-between w-100">
                                ...
                                <div class="form-group d-inline-flex align-items-center justify-content-between w-100">
                                    ...
                                    <input type="number" class="form-control shadow-sm rounded" name="alt_phone_number">
                                </div>  
                                <div class="form-group d-inline-flex align-items-center justify-content-between w-100">
                                    <label class="form-label mr-2 mb-0">Address:</label>
                                    <textarea class="form-control shadow-sm rounded" name="address" rows="3"></textarea>
                                </div>                                                
                            </div>
                            <div class="col-md-6">
                                <div class="form-group d-inline-flex align-items-center justify-content-between w-100">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="#deleteModal{{ $info->id }}" data-toggle="modal" class="btn btn-danger" >Delete</a>

                                <!-- Delete Modal -->
                                {{-- {{ route('admin.product.edit', $product->id) }} --}}
                                
                                <div class="modal fade" id="deleteModal{{ $info->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
